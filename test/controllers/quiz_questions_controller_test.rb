...
class QuizQuestionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create quiz_question" do
    assert_difference('QuizQuestion.count') do
      post quiz_questions_url, params: { quiz_question: { question: @quiz_question.question, question_option_ids: @quiz_question.question_option_ids, quiz_id: @quiz_question.quiz_id } }, as: :json
    end
  ...
  test "should update quiz_question" do
    patch quiz_question_url(@quiz_question), params: { quiz_question: { question: @quiz_question.question, question_option_ids: @quiz_question.question_option_ids, quiz_id: @quiz_question.quiz_id } }, as: :json
    assert_response 200
  end
